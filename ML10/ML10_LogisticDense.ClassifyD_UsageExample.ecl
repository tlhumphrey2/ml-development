//ML10_LogisticDense.ClassifyD_UsageExample2.ecl
IMPORT ML;
value_record := RECORD
UNSIGNED rid;
REAL age;
...
//Uses PBblas/AutoMap.ecl
MyLogisticRegression:=ML.Classify.Logistic();


//Manually sets partition block sizes

/*Note that though there are to independent
  variables, the partition size for the columns
  is 3. This is because a column of 1's is 
  inserted in the Logistic module.
*/

//MyLogisticRegression:=ML.Classify.Logistic(,,,32,3);
