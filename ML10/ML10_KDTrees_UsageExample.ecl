...
OUTPUT(C.Splits,NAMED('KDTreeSplits'));
OUTPUT(C.Partitioned,NAMED('KDTreePartitioned'));
OUTPUT(C.Counts,NAMED('KDTreeCounts'));
OUTPUT(C.Extents,NAMED('KDTreeExtents'));
